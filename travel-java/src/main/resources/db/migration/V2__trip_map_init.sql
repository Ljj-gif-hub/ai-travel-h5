...
-- 【SQL-3 修复】统一 MySQL 方言：CLOB→TEXT、MERGE INTO→INSERT IGNORE。
-- 生产 MySQL 按序重放迁移链时不再报语法错误（dev 的 H2 由 ddl-auto=update 自动建表，不依赖本脚本）。
-- ================================================================
...
-- ================================================================
-- 种子数据: 北京酒店（10家）
-- 使用 INSERT IGNORE 避免重复插入（MySQL 幂等，主键冲突即跳过）
-- ================================================================
INSERT IGNORE INTO hotels (id, name, city, district, address, latitude, longitude, price_per_night, rating, image_url, amenities) VALUES
...
-- 种子数据: 北京地标（15个）
-- ================================================================
INSERT IGNORE INTO landmarks (id, name, city, type, latitude, longitude, description, icon_url) VALUES
