...
export default {
  ...
  noRouteHint: 'Plan your first route',
  aiPlanTitle: 'AI plans your trip',
  routesCount: '{n} routes saved',
  loginToViewRoutes: 'Log in to sync your routes',
  recommendLabel: '🔥 Must-see',
  locating: 'Locating…',
